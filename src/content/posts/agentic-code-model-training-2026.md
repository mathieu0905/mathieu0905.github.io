...
对我的启发是：如果面试九坤/基模组，不能只讲“我做了 SWE-bench 实验”。更好的说法是：
...
[IQuest-Coder-V1 Technical Report](https://arxiv.org/abs/2603.16733) 是这份清单里最需要精读的材料之一。它和九坤/至知相关方向更接近，也和我的经历最容易对齐。
